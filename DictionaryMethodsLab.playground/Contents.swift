 ...
 */
for listsOfCharacters in starWarsCharacters.keys {
    print(listsOfCharacters)
}
...
// should expect to see 4 items in the dictionary.
 ...
 */
let update = starWarsCharacters.updateValue(starsWarsJedi, forKey: "Jedi")
 ...
 */
let noBountyHunters = starWarsCharacters.removeValueForKey("Bounty Hunters")

if noBountyHunters == nil {
